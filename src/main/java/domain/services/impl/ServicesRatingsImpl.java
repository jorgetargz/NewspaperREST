...
public class ServicesRatingsImpl implements ServicesRatings {
    ...
    @Override
    public boolean updateRating(ArticleRating articleRating) {
        return daoRatings.update(articleRating);
    }

    @Override
    public boolean saveRating(ArticleRating articleRating) {
    ...
    @Override
    public boolean deleteRating(ArticleRating articleRating) {
        return daoRatings.delete(articleRating);
    }

    @Override
    public boolean deleteAllRatingsByNewspaper(String newspaperId) {
        try {
            return daoRatings.deleteAllByNewspaperId(Integer.parseInt(newspaperId));
        } catch (NumberFormatException e) {
            throw new ValidationException(Constantes.PARAMETER_ID_MUST_BE_A_NUMBER);
        }
    }
